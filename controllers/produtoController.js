...
class ProdutoController {
    ...
    async cadastrarProduto(req, res) {
        ...
        req.body.marca != '0' && req.body.categoria  != '0' && req.body.valor != '' && req.file != null) {
            let produto = new ProdutoModel(0, req.body.codigo, 
                ...
                req.body.categoria, req.body.marca, "", "", req.body.valor, req.file.filename);
    ...
    async alterarProduto(req, res) {
        ...
        if(req.body.codigo != "" && req.body.nome != "" && req.body.quantidade != "" && req.body.quantidade  != '0' && req.body.marca != '0' && req.body.categoria  != '0' && req.body.valor != "0") {
            ...
            let produto = new ProdutoModel(req.body.id, req.body.codigo, req.body.nome, req.body.quantidade, req.body.categoria, req.body.marca, "", "", req.body.valor, imagem);
            ok = await produto.gravar();
        }
        else{
            ok = false;
